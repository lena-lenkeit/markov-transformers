...
from markov.sequence_model import LinearSequenceModel


def main():
    # Paths
    save_dir = "data/linear_sequence_model/mess3/"
    ...
    model = LinearSequenceModel(**model_kwargs).to(device)
    ...
    # Save model
    config_dict = {"model": model_kwargs}
